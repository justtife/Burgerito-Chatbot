...
export default class OrderHandler {
  ...
  private orderItems: Item[] = [
    { name: "Burger", price: 10, code: 20 },
    { name: "Burito", price: 20, code: 21 },
    { name: "Small Chops", price: 15, code: 22 },
    { name: "Chicken & Chips", price: 15, code: 23 },
    { name: "Coca Cola", price: 15, code: 24 },
  ];
  private comboItems: Item[] = [
    { name: "Burito, Coca Cola", price: 10, code: 30 },
    { name: "Burito, Chicken & Chips, Coca Cola", price: 10, code: 31 },
    { name: "Burito, Small Chops, Coca Cola", price: 10, code: 32 },
    { name: "Burger, Coca Cola", price: 10, code: 33 },
    { name: "Burger, Burito, Coca Cola", price: 10, code: 34 },
    { name: "Burger, Chicken & Chips, Coca Cola", price: 10, code: 35 },
    { name: "Small Chops, Coca Cola", price: 10, code: 36 },
    { name: "Small Chops, Chicken & Chips, Coca Cola", price: 10, code: 37 },
    {
